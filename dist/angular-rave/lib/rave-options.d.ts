export declare class RaveOptions {
    /**
...
export declare class _RaveOptions {
    /**
     * Your merchant public key provided when you create a button
     */
    PBFPubKey: string;
    ...
    meta?: any;
    /**
     * A function to be called on successful card charge. User’s can always be redirected to a successful or failed page supplied by the merchant here based on response
